...
object Translations {
    ...
    private val messages = mapOf(
        ...
        "pt" to mapOf(
            ...
            TranslationKey.HELP to "Para usar esta habilidade, basta invocá-la e ela reproduzirá o video. Você quer que eu jogue agora?",
            TranslationKey.THANKS to "Obrigado por usar essa skill!",
            TranslationKey.FALLBACK to "Uau, algo deu errado. Tente mais tarde",
            TranslationKey.NO_FEATURE to "Nossa, não consigo mudar o video, desculpe"
        )
    )
}